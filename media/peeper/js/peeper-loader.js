...
(function(){
	...
	if (typeof jQuery == "undefined"){
		scripts.push('https://ajax.googleapis.com/ajax/libs/jquery/1.5.1/jquery.min.js');
	}
	
	scripts.push('<?php echo URL::site() ?>peeper/media/js/class.js');
	scripts.push('<?php echo URL::site() ?>peeper/media/js/peeper.js');
	
	// Load
	LazyLoad.loadOnce(scripts, function(){
		Peeper = new Peeper('<?php echo URL::site() ?>');
		Peeper
			.setLogsNumber(50)
			.suckMilk();
	});
